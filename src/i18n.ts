...
const strings: Record<Lang, Record<string, string>> = {
  en: {
    ...
    sysNotCompleteDesc: "Part of LumaDeck isn't installed. Press to finish setup.",
  ...
  "pt-BR": {
    ...
    sysNotCompleteDesc: "Parte do LumaDeck não está instalada. Toque para concluir a instalação.",
