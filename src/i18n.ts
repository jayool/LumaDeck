...
const strings: Record<Lang, Record<string, string>> = {
  en: {
    ...
    healthPausedByGuard: "Paused by crash guard. Press Retry to re-enable.",
  ...
  "pt-BR": {
    ...
    healthPausedByGuard: "Pausado pela proteção contra travamentos. Toque em Tentar de novo para reativar.",
