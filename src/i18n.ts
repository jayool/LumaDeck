...
const strings: Record<Lang, Record<string, string>> = {
  en: {
    ...
    llInstalledBody: "Restart Steam from the SLSsteam panel above for it to load.",
    platform: "Platform",
  ...
  "pt-BR": {
    ...
    llInstalledBody: "Reinicie a Steam pelo painel SLSsteam acima para que ele carregue.",
    platform: "Plataforma",
    languageIdioma: "Language / Idioma",
    currentEnglish: "Current: English",
    currentPortuguese: "Atual: Português (BR)",
