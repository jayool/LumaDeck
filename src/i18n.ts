...
const strings: Record<Lang, Record<string, string>> = {
  en: {
    ...
    nativeOnlineDesc: "Crack-free co-op for SteamNetworkingSockets games (Lethal Company, Enshrouded…). Sets FakeAppId 480 + the netsock launch option. No Windows DLLs.",
    nativeOnlineAntiCheat: "This game has anti-cheat — netsock scans game memory and would get you banned. Not available.",
    nativeOnlineNoLib: "netsock.so not found — run Install Dependencies first.",
  ...
  "pt-BR": {
    ...
    nativeOnlineDesc: "Co-op sem crack para jogos com SteamNetworkingSockets (Lethal Company, Enshrouded…). Define FakeAppId 480 + a launch option do netsock. Sem DLLs do Windows.",
    nativeOnlineAntiCheat: "Este jogo tem anti-cheat — o netsock lê a memória do jogo e você seria banido. Indisponível.",
    nativeOnlineNoLib: "netsock.so não encontrado — rode Instalar Dependências primeiro.",
