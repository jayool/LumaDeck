...
const strings: Record<Lang, Record<string, string>> = {
  en: {
    ...
    llHealthAllOk: "v{0} loaded — {1}/{2} hooks active",
    llHealthDegraded: "v{0} loaded — {1} failed (Steam update? Reapply lumalinux)",
    llNotLoaded: "Not loaded in Steam yet — restart Steam to activate",
    platform: "Platform",
  ...
  "pt-BR": {
    ...
    llHealthAllOk: "v{0} carregado — {1}/{2} hooks ativos",
    llHealthDegraded: "v{0} carregado — {1} falhou (atualização da Steam? Reaplique o lumalinux)",
    llNotLoaded: "Ainda não carregado na Steam — reinicie a Steam para ativar",
