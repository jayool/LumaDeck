...
const strings: Record<Lang, Record<string, string>> = {
  en: {
    ...
    sysNeedsFix: "Something needs fixing",
    sysNeedsFixDesc: "This switches to Desktop, fixes it, and brings you back.",
  ...
  "pt-BR": {
    ...
    sysNeedsFix: "Algo precisa de correção",
    sysNeedsFixDesc: "Isto vai para o Desktop, corrige e te traz de volta.",
