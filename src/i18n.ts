...
const strings: Record<Lang, Record<string, string>> = {
  en: {
    ...
    // Achievements page (global)
    achievementsPageIntro: "Achievements are generated by SLScheevo. Set it up once here, then generate per-game from a game's page or sync all below.",
    achievementsSetup: "Setup",
    achievementsLogin: "Login",
    slscheevoLoginReady: "Ready",
    slscheevoLoginNeeded: "Login required",
    achievementsReadyAll: "Ready — installed and logged in.",
  ...
  "pt-BR": {
    ...
    // Achievements page (global)
    achievementsPageIntro: "As conquistas são geradas pelo SLScheevo. Configure uma vez aqui, depois gere por jogo na página do jogo ou sincronize tudo abaixo.",
    achievementsSetup: "Configuração",
    achievementsLogin: "Login",
    slscheevoLoginReady: "Pronto",
    slscheevoLoginNeeded: "Login necessário",
    achievementsReadyAll: "Pronto — instalado e com login feito.",
