...
const strings: Record<Lang, Record<string, string>> = {
  en: {
    ...
    sysSteamTooNewDesc: "A recent Steam update broke compatibility. Open Desktop Mode and run enter-the-wired to roll Steam back.",
  ...
  "pt-BR": {
    ...
    sysSteamTooNewDesc: "Uma atualização recente da Steam quebrou a compatibilidade. Abra o Modo Desktop e rode o enter-the-wired para reverter a Steam.",
