...
const strings: Record<Lang, Record<string, string>> = {
  en: {
    ...
    sysSteamTooNewDesc: "A Steam update broke things. This switches to Desktop, puts Steam back, and returns you here.",
    ...
    sysCoreIncompleteDesc: "Part of the setup is missing. Reinstall to finish.",
    sysNeedsRepair: "Setup needs repair",
    sysNeedsRepairDesc: "Something broke after a Steam change. Press Repair to fix it.",
    sysNeedsRestart: "Restart needed",
    sysNeedsRestartDesc: "Restart Steam to apply changes.",
    ...
    sysWorking: "Working...",
    sysUnsupportedBuild: "{0} doesn't support this Steam version",
    sysUnsupportedBuildDesc: "Downloads are paused until this is supported. You're already on the right Steam version, so there's nothing to undo.",
    ...
    steamBuildMismatch: "Steam build: {0} ⚠ (supported: {1})",
